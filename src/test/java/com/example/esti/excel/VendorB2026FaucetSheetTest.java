...
class VendorB2026FaucetSheetTest {
    ...
    void 전산코드를_보조품번으로_보존한다() {
        ...
        assertEquals(new BigDecimal("49000"), s.setPrice());
    ...
    void 겹치는_품번은_전산코드로_가른다() {
        ...
        assertEquals(new BigDecimal("73700"), byCode(sets, "K-0310B-46drk0310b").setPrice());
        assertEquals(new BigDecimal("68000"), byCode(sets, "K-0310B-46kfk0310b").setPrice());
