...
class VendorBExcelParserTest {
    ...
    void 양변기_슬롯세트는_計와_부속합이_일치하고_도기는_MAIN관계() {
        ...
        assertEquals(0, new BigDecimal("<PRICE>").compareTo(mc921.setPrice()), "計=부속합");
    ...
    void 세면기는_기본구성_도기원홀_반다리로_세트가_산정() {
        ...
        assertEquals(0, new BigDecimal("<PRICE>").compareTo(il451.setPrice()), "도기원홀+반다리=69000");
    ...
    void 갈라시아_4행형은_도기와_부속을_묶고_합계가_세트가() {
        ...
        assertEquals(0, new BigDecimal("<PRICE>").compareTo(art.setPrice()));
    ...
    void 악세사리_소계세트는_부속합이_세트가와_일치() {
        ...
        assertEquals(0, new BigDecimal("<PRICE>").compareTo(ac.setPrice()));
    ...
    void 단일행형_비데는_부속없이_대리점가로_저장() {
        ...
        assertEquals(0, new BigDecimal("<PRICE>").compareTo(bidet.setPrice()));
    }
    ...
    void 악세사리_A빈_세트도_G_SET_기준으로_세트화_되고_단일품은_독립저장() {
        ...
        assertEquals(0, new BigDecimal("<PRICE>").compareTo(ac8300.setPrice()));
        ...
        assertEquals(0, new BigDecimal("<PRICE>").compareTo(single.setPrice()));
    }
