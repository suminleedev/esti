...
class VendorBAccessoryDbTest extends AbstractVendorBSheetDbVerification {
    ...
    void 세트는_대표_부속_관계와_세트가로_적재() {
        ...
        assertThat(dbSetPriceByBasis(ac8100, BASIS)).isEqualByComparingTo(new BigDecimal("<PRICE>"));
        ...
        assertThat(dbPartPrice(towel)).isEqualByComparingTo(new BigDecimal("<PRICE>"));
    }
    ...
    void U접두_필터는_결합코드로_적재되어_맨품번_미생성() {
        ...
        assertThat(dbSetPriceByBasis(filter, BASIS)).isEqualByComparingTo(new BigDecimal("<PRICE>"));
