...
class VendorBWashbasinDbTest extends AbstractVendorBSheetDbVerification {
    ...
    void IL451B_도기원홀반영_4는대체옵션으로_적재되되_세트가_미포함() {
        ...
        assertThat(dbSetPrice(CAT, il451)).isEqualByComparingTo(price("VendorBWashbasinDbTest.IL451B_도기원홀반영_4는대체옵션으로_적재되되_세트가_미포함"));
    ...
    void L966_반다리채택_긴다리는대체옵션_필수부속포함_87200() {
        ...
        assertThat(dbSetPrice(CAT, l966)).isEqualByComparingTo(price("VendorBWashbasinDbTest.L966_반다리채택_긴다리는대체옵션_필수부속포함_87200"));
    ...
    void 도자종류_중복품번_분기되어_양쪽_보존되고_도자명은_description() {
        ...
        assertThat(dbSetPrice(CAT, hwa)).isEqualByComparingTo(price("VendorBWashbasinDbTest.도자종류_중복품번_분기되어_양쪽_보존되고_도자명은_description"));
        assertThat(dbSetPrice(CAT, cle)).isEqualByComparingTo(price("VendorBWashbasinDbTest.도자종류_중복품번_분기되어_양쪽_보존되고_도자명은_description.2"));
